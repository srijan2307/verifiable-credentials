...
// Define the key pair
$public_key_multibase = "z6Mkj7FsnMem55sN2C75LW7eVxAdwi2ZbURTQQM1UwqtE3Q2";
$private_key_multibase = "zruzj4rDJXgvdnapiEomNNBrRsgQ9HxSSDR8Y18uyoJs2ckjuiEPjn3fCX1hfDru9R5X5PEofYsiY3BquGFqDfJ7ZeN";
...
$private_key_r = substr($privateKey, 2);
...
echo "publickey ;".bin2hex($publicKey)."/";

$public_key_r = substr($publicKey, 2);

//making keypair
//$keypair = $private_key_r . $public_key_r;

if (strlen($private_key_r) !== SODIUM_CRYPTO_SIGN_SECRETKEYBYTES) {
...
// Sign
$signature = sodium_crypto_sign_detached($combined_hash, $private_key_r);
